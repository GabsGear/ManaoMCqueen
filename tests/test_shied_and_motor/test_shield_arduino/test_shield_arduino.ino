...
#define pino_trigger_1 3
#define pino_echo_1 2

#define pino_trigger_2 9
#define pino_echo_2 8

const int motor_1_a = 3; //input 1
const int motor_1_b = 4; //input 2
const int motor_2_a = 5; //input 3
const int motor_2_b = 6; //input 4
...
void loop()
{
  sensor[0] = ler_sensor(pino_trigger_1, pino_echo_1);
  sensor[1] = ler_sensor(pino_trigger_2, pino_echo_2);
...
double ler_sensor(int trigger, int echo)
{
